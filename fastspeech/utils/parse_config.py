...
from fastspeech.logger import setup_logging
from fastspeech.utils import read_json, write_json, ROOT_PATH
...
class ConfigParser:
    ...
    def init_ftn(self, name, module, *args, **kwargs):
        ...
        is equivalent to
        `function = lambda *args, **kwargs: module.name(a, *args, b=1,
        **kwargs)`.
        """
